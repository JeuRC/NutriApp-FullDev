...
namespace NutriApp.App.Persistencia.Migrations
{
    ...
    [Migration("20210923005341_FirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NutriApp.App.Dominio.Historial", b =>
                {
                    b.HasOne("NutriApp.App.Dominio.Seguimiento", "Seguimiento")
                        .WithMany()
            ...
            modelBuilder.Entity("NutriApp.App.Dominio.Paciente", b =>
                {
                    ...
                    b.HasOne("NutriApp.App.Dominio.Historial", "Historial")
                        .WithMany()
                        .HasForeignKey("HistorialId");

                    b.HasOne("NutriApp.App.Dominio.Nutricionista", "Nutricionista")
                        .WithMany()
